...
const COL_NOTAS = [
  ...
  { titulo: 'Nota de origem', chave: 'nota_origem', tipo: 'codigo', largura: 13 },
  { titulo: 'Série', chave: 'serie', largura: 7 },
  { titulo: 'Nº do pedido', chave: 'pedido', tipo: 'codigo', largura: 13 },
  { titulo: 'Tabela de preço', chave: 'tabela_preco', largura: 14 },
  ...
  { titulo: 'Observação', chave: 'observacao', largura: 36 },
